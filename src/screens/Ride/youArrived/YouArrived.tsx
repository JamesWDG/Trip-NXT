...
const YouArrived = ({ navigation }: { navigation: NavigationProp<any> }) => {
  ...
  const handleCancelRequest = () => {
    ...
    setTimeout(() => {
      navigation.navigate('TripDetailsForRide');
    }, 100);
  };

  return (
    <RideWrapper navigation={navigation} source={images.you_arrived}>
      <PrimaryHeader
