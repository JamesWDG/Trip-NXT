...
export const endpoint: endpointTypes = {
  ...
  GET_SINGLE_HOTEL_BOOKING: (id: number) =>
    `booking/get-single-hotel-booking/${id}`,
  UPDATE_HOTEL_BOOKING_STATUS: (id: number) =>
    `booking/update-hotel-booking-status/${id}`,
  ADD_TO_WISHLIST: 'wishlist/',
  DELETE_FROM_WISHLIST: (id: number, type: 'hotel' | 'dish') =>
    `wishlist/${id}/${type}`,
  GET_WISHLIST: 'wishlist/',
  CREATE_REVIEW: 'review/create-review',
  GET_REVIEWS_BY_RESTAURANT_ID: (id: number) =>
    `review/get-reviews-by-restaurant-id/${id}`,
  GET_REVIEWS_BY_MENU_ITEM_ID: (id: number) =>
    `review/get-reviews-by-menu-item-id/${id}`,
